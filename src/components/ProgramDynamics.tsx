      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-24">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="space-y-5 text-blue-900/90 font-sans text-sm sm:text-base font-light leading-relaxed">
              <p>
                <strong className="text-blue-950 font-semibold text-lg block mb-1">Aarambh — आरम्भ — means beginning.</strong>
                The fellowship is built on a simple belief:
              </p>
              
              <div className="relative border-l-4 border-blue-600 pl-4 py-2.5 my-4 italic text-blue-950 bg-blue-50/80 rounded-r font-medium">
                People learn fastest when they are trusted with real responsibility.
              </div>

              <p>
                Fellows work directly on active systems operated by <span className="text-blue-950 font-medium">Sanshi Network Tech Pvt. Ltd.</span> across product, growth, media, partnerships, community, and infrastructure.
              </p>
              <p>
          ...
          <div className="lg:col-span-5 bg-blue-50/60 p-8 sm:p-10 border border-blue-100 rounded-lg relative overflow-hidden">
            ...
            <div className="space-y-4 text-blue-800 font-sans text-xs sm:text-sm font-light leading-relaxed mb-6">
              <p>
              ...
              <p className="font-semibold text-blue-900 border-b border-blue-100 pb-2">
                The structure is intentionally small:
              </p>
              <ul className="space-y-2 pl-1 font-mono text-xs text-blue-800">
                <li className="flex items-center gap-2">
                  <span className="text-blue-600 font-bold">•</span> 10 fellows only
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-600 font-bold">•</span> founder-led coordination
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-600 font-bold">•</span> direct operational exposure
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-600 font-bold">•</span> continuous production work
                </li>
              </ul>
              <p className="pt-2 border-t border-blue-100 text-xs text-blue-600 italic">
        ...
        {/* The Three Pillars Grid - Beautiful Premium Cards with Aceternity style double-borders and glowing accents */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24 py-6">
          
          {/* Card 1: Ownership */}
          <div 
            className="group relative bg-white border border-blue-100 hover:border-blue-400 p-8 rounded-xl flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 shadow-[0_2px_10px_rgba(59,130,246,0.015)] hover:shadow-[0_8px_25px_rgba(59,130,246,0.05)] overflow-hidden"
            id="card-pillar-ownership"
          >
            {/* Fine Spotlight Glow Effect */}
            <div className="absolute inset-0 bg-radial-gradient(circle_at_top,_rgba(59,130,246,0.03)_0%,_transparent_60%) pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            
            <div className="relative z-10">
              {/* Icon Container with double frame styling */}
              <div className="w-12 h-12 bg-blue-50/70 border border-blue-100 group-hover:bg-blue-600 group-hover:border-blue-600 rounded-lg flex items-center justify-center text-blue-600 group-hover:text-white transition-all duration-300 mb-6">
                <Flame className="w-5 h-5 transition-transform duration-300 group-hover:scale-110" />
              </div>
              
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded bg-blue-50 border border-blue-200/50 text-blue-700 text-[10px] font-mono font-bold uppercase tracking-tight mb-4">
                Pillar 01 • Autonomy
              </div>
              
              <h3 className="text-xl text-slate-900 font-extrabold font-sans mb-3 group-hover:text-blue-650 transition-colors">
                Ownership
              </h3>
              
              <p className="text-xs sm:text-sm text-slate-650 font-medium leading-relaxed mb-6 font-sans">
            ...
            <div className="pt-4 border-t border-slate-100 relative z-10 font-mono text-[9px] text-blue-500 uppercase tracking-widest flex items-center gap-1.5 font-bold">
        ...
        <div className="flex flex-col">
          <div className="mb-10 text-center max-w-2xl mx-auto">
            ...
            <p className="text-sm text-blue-800/80 font-light">
                ...
                >
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-mono text-blue-600/70 uppercase">Season {season.id === "varsha" ? "1" : season.id === "sharad" ? "2" : season.id === "vasant" ? "3" : "4"}</span>
                      {season.active && (
                    ...
                    <span className="font-sans font-semibold text-base text-blue-900 mt-1 group-hover:text-blue-700 transition-colors">
                      {season.name}
                    </span>
                  </div>
                ...
                >
                  <div className="flex items-center justify-between border-b border-blue-100 pb-5 mb-5">
                    <div>
                      ...
                      <h3 className="text-xl sm:text-2xl font-serif text-blue-900 font-bold h-7">
                  ...
                  <p className="text-blue-900 font-sans text-sm sm:text-base leading-relaxed mb-6 font-light">
